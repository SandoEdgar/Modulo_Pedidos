...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/dist/css/cssListaOrdenCompra/estiloFrmListarCompra.css" rel="stylesheet" type="text/css"/>
        <title>Lista de Orden de Compra</title>
    </head>
    <body>
         ...
         <center>
          ...
          <div class="boton">
              <img src="<%=request.getContextPath()%>/dist/img/imagenesListaOrdenCompra/buscar.png" alt="" height="15"/>
